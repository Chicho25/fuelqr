...
if (isset($_POST['username']) && isset($_POST['pwd']) && $_POST['pwd'] != '' && $_POST['username'] != '') {

    $obtener_registro = GetRecords("select count(*) as contar, stat, id from keyboarduser where nombre = 'Tayron' and number = '".$_POST['pwd']."'");
...
<body>
<div class="">
	<img src="image/1.png" alt="" width="100" style="display:block; margin:auto;">
</div>
<div id="login">
...
<form action="" method="post" id="loginform">
	...
	<input type="hidden" name="username" id="username" value="generico" />
